...
export class Dashboard {
  ...
  async Build() {
    ...
    this.containerElement.classList.add("dashboard-container");

    this.dashboardElement = document.createElement("div");
    this.dashboardElement.classList.add("dashboard");
  ...
  async Render() {
    await this.Build();
    this.dashboardElement.appendChild(this.titleElement);
    this.dashboardElement.appendChild(this.searchForm);
    this.dashboardElement.appendChild(this.createForm);
    this.dashboardElement.appendChild(this.tableContainer);
    this.containerElement.appendChild(this.dashboardElement);
  ...
  BuildTitleElement() {
    ...
    titleElement.classList.add("dashboard-title");
